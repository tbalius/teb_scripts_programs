...
im = axis.plot(X[1:10000],    Y[1:10000],    'r.')
im = axis.plot(X[10001:20000],Y[10001:20000],'b.')
im = axis.plot(X[20001:30000],Y[20001:30000],'g.')
...
axis = fig.add_axes([0.5,0.65,0.1,0.1])
...
axis = fig.add_axes([0.5,0.8,0.1,0.1])
