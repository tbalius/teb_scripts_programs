...
set workdir = ${pwd}/${pdb}/004.MDrun_${seed}
#set workdir = ${pwd}/${pdb}/004.MDrun_mod_${seed}
set filedir = ${pwd}/${pdb}/003md_tleap
...
set restraint_mask_equil2 = ':1-172 & \!@H'  
set restraint_mask_equil3 = '(:1-169 & @CA,C,O,N) | (:170 & \!@H)'  # release sidechains and but restrain ligand
set restraint_mask_equil4 = ':1-169 & @CA,C,O,N'  # release sidechains and ligand frist
...
set restraint_mask = ''
set ntr = "0" 
set nameprefix     = "com.watbox.leap"
...
source /home/baliuste/.cshrc.amber
...
01mi.in: equil minimization with very strong Cartesian restraints
&cntrl
   imin=1, maxcyc=20000, ncyc = 10000, 
   ntpr=100, 
   ntr=${ntr_equil}, 
   restraint_wt=100.0, 
...
&cntrl
   ...
   ntr=${ntr_equil}, 
   iwrap=1,
   restraintmask = '${restraint_mask_equil4}', restraint_wt = 5.0,
/
EOF1
