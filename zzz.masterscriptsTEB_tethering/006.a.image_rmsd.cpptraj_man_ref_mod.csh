...
set workdir  = $mountdir/${pdb}/006.rmsd_${seed}_man_ref_mod/
rm -rf $workdir
mkdir -p $workdir
cd $workdir
...
set seed_ref = "0"
set num = 09 # the frist chunk
set frame = 13
set file = `ls ${mountdir}/${pdb}/004.MDrun_${seed_ref}/*/${num}md.mdcrd`

# make reference
cat << EOF >! make_man_ref.in
parm $jobId/com.watbox.leap.prm7
trajin $file $frame $frame
autoimage :1-171
#strip :WAT
