...
for mol in mol_list:
    ...
    # add dummy1 and dummy2 to the atoms.  dummy1 is a duplicate of atom1 and dummy2 is a duplicate of atom2

    a = mol.atom_list[atom1num-1]
    print (atom1num, a.num)
    oriatomsize = len(mol.atom_list)
    dummy1num = oriatomsize+1
    dummy2num = oriatomsize+2
    #dummy1 = mol2.atom(X,Y,Z,Q,type,name,num,resnum,resname)) 
    dummy1 = mol2.atom(a.X,a.Y,a.Z,0.0,'Du',"DA",dummy1num,a.resnum,a.resname) 
    a = mol.atom_list[atom2num-1]
    dummy2 = mol2.atom(a.X,a.Y,a.Z,0.0,'Du',"DB",dummy2num,a.resnum,a.resname) 
    mol.atom_list.append(dummy1)
    mol.atom_list.append(dummy2)

    # add bond between dummy1 and atom2 and between dummy2 and atom1.  
    
    oribondsize = len(mol.bond_list)
    b1 = mol2.bond(atom1num,dummy2num,oribondsize+1,'1')
    b2 = mol2.bond(atom2num,dummy1num,oribondsize+2,'1')
    mol.bond_list.append(b1)
    mol.bond_list.append(b2)
