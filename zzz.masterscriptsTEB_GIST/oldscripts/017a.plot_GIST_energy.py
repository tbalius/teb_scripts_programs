...
# cp /mnt/nfs/work/rstein/RotationProjectDUDEGIST/mod_plot_GIST_energy.py 017a.plot_GIST_energy.py

def plot_hist(energy_file, system, docktype):
	...
	#axarr[1, 1].set_title('Axis [1,1]')
        n, bins, patches = axarr[0].hist(ligand_energy_list, num_bins,color='red')
        n2, bins2, patches2 = axarr[1].hist(decoy_energy_list, num_bins,color='green')
...
#	print len(n),len(bins),len(patches)
        axarr[2].plot(meanbins,n/s1,'r-',meanbins2,n2/s2,'g-',bins2,y,'k--')
        #plt.plot(bins, y, 'r--')
	...
	output = open(docktype+"_normal","w")	
	output.write(str(mu)+" "+str(sigma))
	output.close()
...
#        sys_dict = {"ampC":["1L2S_10-22_GIST"],"HSP90":["1UYG_12-4_GIST"],"NA":["1B9V_10-22_GIST"],"FA10":["3KL6_11-15_GIST"],"ACES":["1E66_10-22_GIST"],"HIVPR":["1XL2_aligned_10-22_GIST"],"PUR2":["1NJS_10-22_GIST"],"EGFR":["2RGP_TKD_aligned_10-22_GIST"],"HMDH":["3CCW_10-22_GIST"],"TRYP":["2AYW_10-22_GIST"],"KITH":["2B8T_12-4_GIST"],"AA2AR":["3EML_aligned_10-22_GIST"]}

        sys_dict = {"HSP90":["docking/2runEnrich/4NVA_gist/"]}
		...
		plot_hist(new_file, sys, docktype)
