...
set filedir = $mountdir/mainstate/rmsd_prealign
set workdir = $mountdir/mainstate/clustering_prealign
...
if (-e $workdir) then
 ...
 python ${mountdir}/for002.rmsd_cluster_single.py ${filedir}/loop_process.txt   matrix_loop_single_hist   0.6 1.0 > ! matrix_loop_single_hist.0.6.log.txt
