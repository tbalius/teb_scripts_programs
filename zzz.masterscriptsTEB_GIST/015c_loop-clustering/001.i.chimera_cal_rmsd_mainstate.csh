...
set workdir = $mountdir/mainstate/rmsd
...
#  set name = `echo $file | awk -F\/ '{print $'$field'}' `
#
# 
#  echo $name
#
...
foreach pdb ($list)
 ...
 grep "^.....................A\|X\|B" $name1.pdb.old > $name1.pdb # to only have one chain. # CHANGE THIS. may need tinkering
