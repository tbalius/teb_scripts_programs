...
def calc_score(fileprefix,values,gridscale,xn,yn,zn,origin,mol,vdw_dict,fileh):
# file - log file
# values gist values 
...
def main():
   ...
   count = 0
   for mol in mols:
      new_values = calc_score(outfile,values,gridscale,xn,yn,zn,origin, mol,vdwdict,file1)
