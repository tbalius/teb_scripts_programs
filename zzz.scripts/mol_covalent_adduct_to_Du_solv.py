#import mol2  ## this is a libary Trent Balius and Sudipto Mukherjee . 
import mol2_python3 as mol2  ## this is a libary Trent Balius and Sudipto Mukherjee . 
import math, sys
import os.path
import gzip
import copy
...
#################################################################################################################
# Written by Trent E Balius, March 2020 FNLCR, modified in April 15, 2020  
# This script will modify the the mol2 file it will search for CB and SG. 
# Remove the hydrogen that are connected to the CB and SG atoms.
# the one with 0 hydrogens becomes D1 with type Du.
