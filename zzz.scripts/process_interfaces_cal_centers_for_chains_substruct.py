        ...
        for i in range(0,len(atom_list1)):
           ...
           for j in range(0,len(atom_list2)):
               ...
               if (dist2<threshold**2.0): 
                   ...
                   interface1[atom_list2[j].resname+atom_list2[j].resnum] = int(atom_list2[j].resnum)
                   interface2[atom_list1[i].resname+atom_list1[i].resnum] = int(atom_list1[i].resnum)
