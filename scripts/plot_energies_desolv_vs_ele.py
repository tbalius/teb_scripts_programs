...
stats_fig(es_array,tds_array,'es','tot_desol',title+'_correlation_es_ds.png',title)
stats_fig(es_array,rds_array,'es','rec_desol',title+'_correlation_es_rds.png',title)
stats_fig(es_array,lds_array,'es','lig_desol',title+'_correlation_es_lds.png',title)
