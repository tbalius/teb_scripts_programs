...
set workdir = ${pwd}/${pdb}/0004.MDrun_mod_${seed}
...
#set restraint_mask_equil2 = ':1-967 & \!@H'  
#set restraint_mask_equil3 = ':1-967 & @CA,C,O,N'  # release sidechains and ligand frist
set restraint_mask_equil2 = ':1-1002 & \!@H'  
set restraint_mask_equil3 = ':1-1002 & @CA,C,O,N'  # release sidechains and ligand frist
...
set restraint_mask = ':1,218,221,499,501,718,721,999 & @CA,C,O,N'
set ntr = "1" 
set nameprefix     = "com4.watbox.leap"
