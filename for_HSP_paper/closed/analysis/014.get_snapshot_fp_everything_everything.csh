...
#set workdir  = $mountdir/${pdb}/014.seed_${seed}.footprint/
  ...
  set script = "/home/${username}/zzz.github/teb_scripts_programs/py_amber_reader/"
   ...
   foreach rst ($list)
    ...
    python ${script}/examples_analysis/heatmap_matrix_mod.py vdw${rst:t:r}_fp.avg 1.0 -1.0 1.0 lab.txt lab.txt > heatmap_matrix.VDW.log
    python ${script}/examples_analysis/heatmap_matrix_mod.py ele${rst:t:r}_fp.avg 50.0 -50.0 50.0 lab.txt lab.txt > heatmap_matrix.ES.log
