...
set workdir  = $mountdir/${pdb}/014.footprint_overtime/${name}_seed_${seed}/
...
set mask2 = "959"
   ...
   #set traj = ${mountdir}/${pdb}/old2/0007.com.rec.lig_${seed}/com.1.nowat.mdcrd
   ...
   python ${script}/examples_analysis/get_one_cell_plot.py vdw${mask1}_${mask2}_seed${seed} 0 24999 1 1 vdw${mask1}_${mask2}_seed${seed} vdw${mask1}_${mask2}_seed${seed} 
   python ${script}/examples_analysis/get_one_cell_plot.py ele${mask1}_${mask2}_seed${seed} 0 24999 1 1 ele${mask1}_${mask2}_seed${seed} ele${mask1}_${mask2}_seed${seed}
