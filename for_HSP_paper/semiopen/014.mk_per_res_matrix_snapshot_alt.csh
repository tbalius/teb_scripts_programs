...
set workdir  = $mountdir/${pdb}/014.footprint_single_point_nomod/name_${name}/

rm -rf $workdir
mkdir -p $workdir
cd $workdir

echo "${mountdir}/../Semi/0004.min/*.rst7"
ls ${mountdir}/../Semi/0004.min/*.rst7

set list = `ls ${mountdir}/../Semi/0004.min/*.rst7`
set prm  =  ${mountdir}/../Semi/0003md_tleap/com4.mm.leap.prm7 
