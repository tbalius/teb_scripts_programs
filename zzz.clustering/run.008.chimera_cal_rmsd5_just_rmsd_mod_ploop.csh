...
#"/mnt/nfs/soft/chimera/current/bin/chimera"
...
rm  chimera_script.*align*.output  # remove all lines that do not contain 'align'
rm  chimera_script.*align*.com  # remove all lines that do not contain 'align' 
...
if ($sel_id == "full_3") then
   set seltion = "#0:2-9,18-25,39-50,77-121,127-164@N,CA,C,O #1:2-9,18-25,39-50,77-121,127-164@N,CA,C,O"
else if ($sel_id == "ploop") then
   #set seltion = "#0:185-194@N,CA,C,O #1:185-194@N,CA,C,O"
   set seltion = "#0:10-17@N,CA,C,O #1:10-17@N,CA,C,O"
...
$chimerapath --nogui --script "/home/baliuste/zzz.scripts/chimera_rmsd.py $mountdir/aligned_list_switchII.txt '$seltion' " > ! $sel_id.txt
