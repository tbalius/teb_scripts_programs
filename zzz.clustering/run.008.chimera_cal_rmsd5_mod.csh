...
open $template $pdb
# do alignment
#match #1:2-25,39-50,72-164@N,CA,C,O #0:2-25,39-50,72-164@N,CA,C,O
match #1:2-9,18-25,39-50,77-121,127-164@N,CA,C,O #0:2-9,18-25,39-50,77-121,127-164@N,CA,C,O
...
if ($sel_id == "full") then
   set seltion = "#0:2-25,39-50,72-121,127-164@N,CA,C,O #1:2-25,39-50,72-121,127-164@N,CA,C,O"
else if ($sel_id == "loop") then
